...
describe('LLM Providers - Individual Testing', function() {
  ...
  describe('OpenRouter GPT LLM Provider', function() {
    ...
    before(function() {
      if (!testConfig.OPENAI_API_KEY) {
        console.log('⚠️  Skipping OpenRouter GPT tests - OPENAI_API_KEY not found');
        this.skip();
      }
    ...
    it('should initialize with correct configuration', function() {
      ...
      assert.strictEqual(provider.config.apiUrl, 'https://api.openai.com/v1/chat/completions', 'Should use OpenRouter API URL');
      assert(provider.apiKey, 'Should have API key');
  ...
  describe('OpenRouter Gemini LLM Provider', function() {
    ...
    before(function() {
      if (!testConfig.OPENAI_API_KEY) {
        console.log('⚠️  Skipping OpenRouter Gemini tests - OPENAI_API_KEY not found');
        this.skip();
      }
  ...
  describe('ARK Doubao LLM Provider', function() {
    ...
    before(function() {
      if (!testConfig.OPENAI_API_KEY) {
        console.log('⚠️  Skipping ARK Doubao tests - OPENAI_API_KEY not found');
        this.skip();
      }
    ...
    it('should initialize with correct configuration', function() {
      ...
      assert.strictEqual(provider.config.apiUrl, 'https://api.openai.com/v1/chat/completions', 'Should use ARK API URL');
      assert(provider.apiKey, 'Should have API key');
  ...
  describe('LLM Provider Performance Comparison', function() {
    it('should compare provider response times', async function() {
      ...
      if (testConfig.OPENAI_API_KEY) availableProviders.push('ark');
