...
class UserMemoryAgent:
    ...
    def __init__(self,
        ...
        # OPENAI_API_KEY present -> route this agent through OpenRouter.
        if not api_key and self.provider != "openrouter" and Config.OPENAI_API_KEY:
        ...
        if not api_key:
            raise ValueError(
                ...
                f"provider's key or OPENAI_API_KEY to use the OpenRouter fallback."
            )
