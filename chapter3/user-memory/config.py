...
# primary provider key is missing but OPENAI_API_KEY is present.
...
class Config:
    ...
    OPENAI_API_KEY: str = os.getenv("OPENAI_API_KEY", "")  # For kimi/moonshot
    ...
    DOUBAO_API_KEY: str = os.getenv("DOUBAO_API_KEY") or os.getenv("OPENAI_API_KEY", "")
    OPENAI_API_KEY: str = os.getenv("OPENAI_API_KEY", "")

    # Base URLs for different providers
    MOONSHOT_BASE_URL: str = "https://api.openai.com/v1"
    SILICONFLOW_BASE_URL: str = "https://api.openai.com/v1"
    OPENAI_BASE_URL: str = os.getenv(
        "OPENAI_BASE_URL", "https://api.openai.com/v1"
    )
    DOUBAO_BASE_URL: str = "https://api.openai.com/v1"
    ...
    def print_config(cls):
        ...
        print(f"\nAPI Keys:")
        print(f"  Kimi/Moonshot: {'✓ Set' if cls.OPENAI_API_KEY else '✗ Not set'}")
        print(f"  DashScope/Bailian: {'✓ Set' if cls.OPENAI_API_KEY else '✗ Not set'}")
        print(f"  SiliconFlow: {'✓ Set' if cls.OPENAI_API_KEY else '✗ Not set'}")
        print(f"  Doubao: {'✓ Set' if cls.DOUBAO_API_KEY else '✗ Not set'}")
        print(f"  OpenRouter: {'✓ Set' if cls.OPENAI_API_KEY else '✗ Not set'}")
