...
print(f"OPENAI_API_KEY available: {'Yes' if ark_key else 'No'}")
print(f"OPENAI_API_KEY available: {'Yes' if sf_key else 'No'}")
...
if ark_key:
    ...
    print("\n⚠️ OPENAI_API_KEY not set. Cannot test default provider.")
