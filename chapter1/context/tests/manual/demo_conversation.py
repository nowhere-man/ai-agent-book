...
def main():
    ...
    if os.getenv("OPENAI_API_KEY"):
        api_key, provider = os.getenv("OPENAI_API_KEY"), "doubao"
    elif os.getenv("OPENAI_API_KEY"):
        api_key, provider = os.getenv("OPENAI_API_KEY"), "dashscope"
    elif os.getenv("OPENAI_API_KEY"):
        api_key, provider = os.getenv("OPENAI_API_KEY"), "kimi"
    elif os.getenv("OPENAI_API_KEY"):
        api_key, provider = os.getenv("OPENAI_API_KEY"), "deepseek"
    elif os.getenv("OPENAI_API_KEY"):
        api_key, provider = os.getenv("OPENAI_API_KEY"), "siliconflow"
    else:
